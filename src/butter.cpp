...
class Butter2 {
 public:
  ...
  Butter2() {
    // 50 Hz cutoff
    //gain_ = 3.414213562e+00; //gain at dc
    //a_[0] = -0.1715728753; //recurrence relation param(1)
    //a_[1] = 0.0000000000; //recurrence relation param(2)
    ...
    // 20 Hz cutoff, 50 Hz 
    //gain_ = 1.565078650e+00;
    //a_[0] = -0.4128015981;
    //a_[1] = -1.1429805025;

    // 15 Hz cutoff, 200 Hz 
    //gain_ = 2.424034560e+01;
    //a_[0] = -0.5139818942;
    //a_[1] = 1.3489677453;

    // 15 Hz cutoff, 50 Hz 
    gain_ = 2.555350342e+00;
    a_[0] = -0.1958157127;
    a_[1] = -0.3695273774;
